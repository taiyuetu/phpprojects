...
<div class="card card-table">
    <div class="card-header bg-white">
        <form method="GET" action="<?= url('/customers') ?>" class="d-flex gap-2">
            <input type="text" name="q" class="form-control form-control-sm" style="max-width:280px"
                   placeholder="搜索姓名、公司、邮箱…" value="<?= e($search) ?>">
    ...
    <div class="table-responsive">
        <table class="table mb-0 align-middle">
            ...
            <tbody>
            <?php if (!$customers): ?>
                <tr><td colspan="7" class="text-center text-muted p-4">未找到客户。</td></tr>
            <?php endif; ?>
            <?php foreach ($customers as $c): ?>
                <tr>
                    ...
                    <td class="text-end">
                        <a href="<?= url('/customers/' . $c['id'] . '/edit') ?>" class="btn btn-sm btn-outline-secondary">
