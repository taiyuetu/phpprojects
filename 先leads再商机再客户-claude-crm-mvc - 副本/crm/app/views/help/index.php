...
<div class="card card-table p-4 mb-4">
    ...
    <p class="mb-3">系统的三个核心模块遵循标准的销售漏斗流程：</p>
    <div class="d-flex align-items-center flex-wrap gap-2 mb-3">
        <span class="badge text-bg-info fs-6 px-3 py-2">线索</span>
        <i class="bi bi-arrow-right fs-4 text-muted"></i>
        <span class="badge text-bg-primary fs-6 px-3 py-2">商机</span>
        <i class="bi bi-arrow-right fs-4 text-muted"></i>
        <span class="badge text-bg-success fs-6 px-3 py-2">客户</span>
    </div>
    <ol class="mb-0">
        <li class="mb-2"><strong>发现线索</strong> — 通过网站、推荐、市场活动等渠道获取潜在联系人信息，创建线索记录。线索是独立的，不关联任何客户。</li>
        <li class="mb-2"><strong>跟进确认</strong> — 联系线索中的联系人，确认其真实需求。更新线索状态（新建 → 已联系 → 已确认）。</li>
        <li class="mb-2"><strong>转为商机</strong> — 线索确认后，点击"转为商机"按钮，系统将<strong>自动创建客户</strong>并生成一条商机记录。</li>
        <li class="mb-0"><strong>推进成交</strong> — 在看板中推进商机阶段（进行中 → 方案阶段 → 谈判中 → 成交）。成交后该客户成为正式客户。</li>
    </ol>
</div>
...
<div class="card card-table p-4 mb-4">
    ...
    <p>显示所有线索，顶部有状态筛选按钮（全部 / 新建 / 已联系 / 已确认 / 已流失）。线索是独立的，不关联任何客户。</p>
    ...
    <table class="table table-sm mb-3">
        ...
        <tbody>
            ...
            <tr><td><span class="badge text-bg-info">已联系</span></td><td>已与联系人取得初步联系</td></tr>
            <tr><td><span class="badge text-bg-primary">已确认</span></td><td>确认有真实需求，可转为商机</td></tr>
            <tr><td><span class="badge text-bg-danger">已流失</span></td><td>联系人无需求或已选择竞品</td></tr>
        </tbody>
    </table>

    <h6 class="text-muted">线索转商机</h6>
    <p>对于已确认的线索（状态不是"已流失"或"已确认"），点击操作栏的绿色转换按钮 <i class="bi bi-arrow-right-circle text-success"></i>，系统将：</p>
    <ol>
        <li>根据线索中的联系人信息<strong>自动创建客户</strong></li>
        <li>创建一条对应的<strong>商机</strong>记录，关联到新客户</li>
        <li>将线索状态标记为"已确认"</li>
    </ol>
    <p class="text-muted small mb-0"><strong>提示：</strong>线索中的"联系人"字段将作为新客户的名称。如果联系人为空，则使用线索标题作为客户名称。</p>
</div>
